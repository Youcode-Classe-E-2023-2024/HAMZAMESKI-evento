                    ...
                    <div
                        ...
                        <div class="mb-6 flex-row md:mb-0 md:flex">
                            <div class="relative mb-3 w-full md:mr-3 md:mb-0" data-te-input-wrapper-init>
                                <input type="email" name="email" id="email" placeholder="Email" class="block text-white w-full p-4 text-lg rounded-sm bg-black border border-gray-600 border-solid focus:border-pink-500 focus:outline-none focus:ring-pink-500">
                            </div>
                            <button type="submit"
